...
0000000080000000 <_entry>:
    ...
    80000004:	4c010113          	addi	sp,sp,1216 # 8001b4c0 <stack0>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000034:	59078793          	addi	a5,a5,1424 # 800235c0 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000050:	24490913          	addi	s2,s2,580 # 8000a290 <kmem>
...
00000000800000ca <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000de:	1b650513          	addi	a0,a0,438 # 8000a290 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    800000ee:	4d650513          	addi	a0,a0,1238 # 800235c0 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    8000010c:	18848493          	addi	s1,s1,392 # 8000a290 <kmem>
  ...
  if(r)
    ...
    80000120:	17450513          	addi	a0,a0,372 # 8000a290 <kmem>
  ...
  release(&kmem.lock);
    ...
    80000144:	15050513          	addi	a0,a0,336 # 8000a290 <kmem>
    ...
    800001c4:	00c587b3          	add	a5,a1,a2
{
    ...
    800001cc:	0705                	addi	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffdba41>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000314:	f5070713          	addi	a4,a4,-176 # 8000a260 <started>
  if(cpuid() == 0){
  ...
  scheduler();        
    ...
    800003b0:	eaf72a23          	sw	a5,-332(a4) # 8000a260 <started>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    800003c6:	ea67b783          	ld	a5,-346(a5) # 8000a268 <kernel_pagetable>
...
0000000080000644 <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    80000654:	c0a7bc23          	sd	a0,-1000(a5) # 8000a268 <kernel_pagetable>
}
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000bf8:	aec48493          	addi	s1,s1,-1300 # 8000a6e0 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
    ...
    80000c02:	fa578793          	addi	a5,a5,-91 # ffffffffa4fa4fa5 <end+0xffffffff24f819e5>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000c22:	4c2a8a93          	addi	s5,s5,1218 # 800100e0 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000c98:	61c50513          	addi	a0,a0,1564 # 8000a2b0 <pid_lock>
  ...
  initlock(&wait_lock, "wait_lock");
    ...
    80000cac:	62050513          	addi	a0,a0,1568 # 8000a2c8 <wait_lock>
    80000cb0:	1f1040ef          	jal	800056a0 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    80000cb4:	0000a497          	auipc	s1,0xa
    80000cb8:	a2c48493          	addi	s1,s1,-1492 # 8000a6e0 <proc>
    ...
    80000cca:	fa578793          	addi	a5,a5,-91 # ffffffffa4fa4fa5 <end+0xffffffff24f819e5>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000ce6:	3fea0a13          	addi	s4,s4,1022 # 800100e0 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    80000d4e:	59650513          	addi	a0,a0,1430 # 8000a2e0 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    80000d74:	54070713          	addi	a4,a4,1344 # 8000a2b0 <pid_lock>
...
0000000080000dc6 <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    80000dd6:	4de90913          	addi	s2,s2,1246 # 8000a2b0 <pid_lock>
...
0000000080000f1e <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000f2e:	7b648493          	addi	s1,s1,1974 # 8000a6e0 <proc>
    80000f32:	0000f917          	auipc	s2,0xf
    80000f36:	1ae90913          	addi	s2,s2,430 # 800100e0 <tickslock>
    acquire(&p->lock);
...
0000000080000fc4 <userinit>:
{
  ...
  initproc = p;
    ...
    80000fd8:	28a7be23          	sd	a0,668(a5) # 8000a270 <initproc>
...
0000000080001082 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80001152:	17a48493          	addi	s1,s1,378 # 8000a2c8 <wait_lock>
...
0000000080001190 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    800011b4:	10070713          	addi	a4,a4,256 # 8000a2b0 <pid_lock>
    800011b8:	975a                	add	a4,a4,s6
    800011ba:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    800011be:	00009717          	auipc	a4,0x9
    800011c2:	12a70713          	addi	a4,a4,298 # 8000a2e8 <cpus+0x8>
    ...
    800011d0:	0e4a0a13          	addi	s4,s4,228 # 8000a2b0 <pid_lock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001234:	4b048493          	addi	s1,s1,1200 # 8000a6e0 <proc>
      if(p->state == RUNNABLE) {
    80001238:	498d                	li	s3,3
    for(p = proc; p < &proc[NPROC]; p++) {
    8000123a:	0000f917          	auipc	s2,0xf
    8000123e:	ea690913          	addi	s2,s2,-346 # 800100e0 <tickslock>
...
0000000080001244 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001268:	04c70713          	addi	a4,a4,76 # 8000a2b0 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    8000128e:	02690913          	addi	s2,s2,38 # 8000a2b0 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    800012a6:	04658593          	addi	a1,a1,70 # 8000a2e8 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000138e:	35648493          	addi	s1,s1,854 # 8000a6e0 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000139a:	d4a90913          	addi	s2,s2,-694 # 800100e0 <tickslock>
...
00000000800013e0 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    800013f6:	2ee48493          	addi	s1,s1,750 # 8000a6e0 <proc>
      pp->parent = initproc;
    800013fa:	00009a17          	auipc	s4,0x9
    800013fe:	e76a0a13          	addi	s4,s4,-394 # 8000a270 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001402:	0000f997          	auipc	s3,0xf
    80001406:	cde98993          	addi	s3,s3,-802 # 800100e0 <tickslock>
...
0000000080001436 <exit>:
{
  ...
  if(p == initproc)
    ...
    80001452:	e227b783          	ld	a5,-478(a5) # 8000a270 <initproc>
  ...
  acquire(&wait_lock);
    ...
    8000149a:	e3248493          	addi	s1,s1,-462 # 8000a2c8 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800014ec:	1f848493          	addi	s1,s1,504 # 8000a6e0 <proc>
    800014f0:	0000f997          	auipc	s3,0xf
    800014f4:	bf098993          	addi	s3,s3,-1040 # 800100e0 <tickslock>
    acquire(&p->lock);
...
000000008000158c <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015ae:	d1e50513          	addi	a0,a0,-738 # 8000a2c8 <wait_lock>
    ...
    800015be:	b2698993          	addi	s3,s3,-1242 # 800100e0 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    800015c2:	00009b97          	auipc	s7,0x9
    800015c6:	d06b8b93          	addi	s7,s7,-762 # 8000a2c8 <wait_lock>
    ...
    800015f8:	cd450513          	addi	a0,a0,-812 # 8000a2c8 <wait_lock>
    ...
    80001622:	caa50513          	addi	a0,a0,-854 # 8000a2c8 <wait_lock>
    ...
    8000166a:	07a48493          	addi	s1,s1,122 # 8000a6e0 <proc>
    8000166e:	b7e1                	j	80001636 <wait+0xaa>
      release(&wait_lock);
    80001670:	00009517          	auipc	a0,0x9
    80001674:	c5850513          	addi	a0,a0,-936 # 8000a2c8 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000173a:	10248493          	addi	s1,s1,258 # 8000a838 <proc+0x158>
    8000173e:	0000f917          	auipc	s2,0xf
    80001742:	afa90913          	addi	s2,s2,-1286 # 80010238 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001836:	8ae50513          	addi	a0,a0,-1874 # 800100e0 <tickslock>
...
clockintr()
{
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    80001922:	7c248493          	addi	s1,s1,1986 # 800100e0 <tickslock>
    80001926:	8526                	mv	a0,s1
    80001928:	5fd030ef          	jal	80005724 <acquire>
    ticks++;
    8000192c:	00009517          	auipc	a0,0x9
    80001930:	94c50513          	addi	a0,a0,-1716 # 8000a278 <ticks>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80001d98:	34c50513          	addi	a0,a0,844 # 800100e0 <tickslock>
    80001d9c:	189030ef          	jal	80005724 <acquire>
  ticks0 = ticks;
    80001da0:	00008917          	auipc	s2,0x8
    80001da4:	4d892903          	lw	s2,1240(s2) # 8000a278 <ticks>
  while(ticks - ticks0 < n){
    ...
    80001db6:	32e98993          	addi	s3,s3,814 # 800100e0 <tickslock>
    80001dba:	00008497          	auipc	s1,0x8
    80001dbe:	4be48493          	addi	s1,s1,1214 # 8000a278 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80001dea:	2fa50513          	addi	a0,a0,762 # 800100e0 <tickslock>
  ...
  return 0;
    ...
    80001e08:	2dc50513          	addi	a0,a0,732 # 800100e0 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80001e48:	29c50513          	addi	a0,a0,668 # 800100e0 <tickslock>
    80001e4c:	0d9030ef          	jal	80005724 <acquire>
  xticks = ticks;
    80001e50:	00008497          	auipc	s1,0x8
    80001e54:	4284a483          	lw	s1,1064(s1) # 8000a278 <ticks>
  release(&tickslock);
    80001e58:	0000e517          	auipc	a0,0xe
    80001e5c:	28850513          	addi	a0,a0,648 # 800100e0 <tickslock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80001f10:	1ec50513          	addi	a0,a0,492 # 800100f8 <bcache>
    80001f14:	011030ef          	jal	80005724 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80001f18:	00016497          	auipc	s1,0x16
    80001f1c:	4984b483          	ld	s1,1176(s1) # 800183b0 <bcache+0x82b8>
    80001f20:	00016797          	auipc	a5,0x16
    80001f24:	44078793          	addi	a5,a5,1088 # 80018360 <bcache+0x8268>
    ...
    80001f4c:	1b050513          	addi	a0,a0,432 # 800100f8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80001f62:	44a4b483          	ld	s1,1098(s1) # 800183a8 <bcache+0x82b0>
    80001f66:	00016797          	auipc	a5,0x16
    80001f6a:	3fa78793          	addi	a5,a5,1018 # 80018360 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80001f9e:	15e50513          	addi	a0,a0,350 # 800100f8 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002026:	0d650513          	addi	a0,a0,214 # 800100f8 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002044:	0b878793          	addi	a5,a5,184 # 800180f8 <bcache+0x8000>
    80002048:	2b87b703          	ld	a4,696(a5)
    8000204c:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    8000204e:	00016717          	auipc	a4,0x16
    80002052:	31270713          	addi	a4,a4,786 # 80018360 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002066:	09650513          	addi	a0,a0,150 # 800100f8 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002096:	06650513          	addi	a0,a0,102 # 800100f8 <bcache>
  ...
  release(&bcache.lock);
    ...
    800020a8:	05450513          	addi	a0,a0,84 # 800100f8 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800020ca:	03250513          	addi	a0,a0,50 # 800100f8 <bcache>
  ...
  release(&bcache.lock);
    ...
    800020dc:	02050513          	addi	a0,a0,32 # 800100f8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002104:	6d45a583          	lw	a1,1748(a1) # 800187d4 <sb+0x1c>
...
000000008000215a <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80002168:	6587a783          	lw	a5,1624(a5) # 800187bc <sb+0x4>
    ...
    80002186:	636b0b13          	addi	s6,s6,1590 # 800187b8 <sb>
      m = 1 << (bi % 8);
...
000000008000232c <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002344:	49850513          	addi	a0,a0,1176 # 800187d8 <itable>
    80002348:	3dc030ef          	jal	80005724 <acquire>
  empty = 0;
    8000234c:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    8000234e:	00016497          	auipc	s1,0x16
    80002352:	4a248493          	addi	s1,s1,1186 # 800187f0 <itable+0x18>
    80002356:	00018697          	auipc	a3,0x18
    8000235a:	f2a68693          	addi	a3,a3,-214 # 8001a280 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002386:	45650513          	addi	a0,a0,1110 # 800187d8 <itable>
  ...
  release(&itable.lock);
    ...
    800023b2:	42a50513          	addi	a0,a0,1066 # 800187d8 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800023f4:	3c898993          	addi	s3,s3,968 # 800187b8 <sb>
  ...
  initlog(dev, &sb);
    ...
    80002420:	39c58593          	addi	a1,a1,924 # 800187b8 <sb>
...
0000000080002444 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    8000245e:	37e50513          	addi	a0,a0,894 # 800187d8 <itable>
    80002462:	23e030ef          	jal	800056a0 <initlock>
  for(i = 0; i < NINODE; i++) {
    80002466:	00016497          	auipc	s1,0x16
    8000246a:	39a48493          	addi	s1,s1,922 # 80018800 <itable+0x28>
    8000246e:	00018997          	auipc	s3,0x18
    80002472:	e2298993          	addi	s3,s3,-478 # 8001a290 <log+0x10>
...
000000008000249c <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800024a8:	32072703          	lw	a4,800(a4) # 800187c4 <sb+0xc>
    ...
    800024c8:	2f4a0a13          	addi	s4,s4,756 # 800187b8 <sb>
...
0000000080002558 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002570:	2645a583          	lw	a1,612(a1) # 800187d0 <sb+0x18>
...
00000000800025d6 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800025e6:	1f650513          	addi	a0,a0,502 # 800187d8 <itable>
  ...
  release(&itable.lock);
    ...
    800025f8:	1e450513          	addi	a0,a0,484 # 800187d8 <itable>
...
000000008000260c <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    8000264e:	1865a583          	lw	a1,390(a1) # 800187d0 <sb+0x18>
...
000000008000278e <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    8000279e:	03e50513          	addi	a0,a0,62 # 800187d8 <itable>
  ...
  release(&itable.lock);
    ...
    800027b8:	02450513          	addi	a0,a0,36 # 800187d8 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    800027e4:	ff850513          	addi	a0,a0,-8 # 800187d8 <itable>
    ...
    8000280a:	fd250513          	addi	a0,a0,-46 # 800187d8 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80002d3e:	54690913          	addi	s2,s2,1350 # 8001a280 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80002d5e:	55670713          	addi	a4,a4,1366 # 8001a2b0 <log+0x30>
...
0000000080002d8c <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80002d90:	5207a783          	lw	a5,1312(a5) # 8001a2ac <log+0x2c>
    80002d94:	0af05263          	blez	a5,80002e38 <install_trans+0xac>
{
    ...
    80002db4:	500a8a93          	addi	s5,s5,1280 # 8001a2b0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80002db8:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80002dba:	00017997          	auipc	s3,0x17
    80002dbe:	4c698993          	addi	s3,s3,1222 # 8001a280 <log>
...
0000000080002e3a <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80002e50:	43448493          	addi	s1,s1,1076 # 8001a280 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80002e86:	42e70713          	addi	a4,a4,1070 # 8001a2b0 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80002ea8:	4007a423          	sw	zero,1032(a5) # 8001a2ac <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80002ece:	3b650513          	addi	a0,a0,950 # 8001a280 <log>
    80002ed2:	053020ef          	jal	80005724 <acquire>
  while(1){
    if(log.committing){
    80002ed6:	00017497          	auipc	s1,0x17
    80002eda:	3aa48493          	addi	s1,s1,938 # 8001a280 <log>
      sleep(&log, &log.lock);
    ...
    80002f12:	37250513          	addi	a0,a0,882 # 8001a280 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80002f38:	34c48493          	addi	s1,s1,844 # 8001a280 <log>
  ...
  if(log.outstanding == 0){
    ...
    80002f56:	32e48493          	addi	s1,s1,814 # 8001a280 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80002f6e:	31648493          	addi	s1,s1,790 # 8001a280 <log>
    ...
    80002fa2:	2e248493          	addi	s1,s1,738 # 8001a280 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80002fca:	2eaa8a93          	addi	s5,s5,746 # 8001a2b0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80002fce:	00017a17          	auipc	s4,0x17
    80002fd2:	2b2a0a13          	addi	s4,s4,690 # 8001a280 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003036:	2607ad23          	sw	zero,634(a5) # 8001a2ac <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    8000305a:	22a90913          	addi	s2,s2,554 # 8001a280 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003094:	22070713          	addi	a4,a4,544 # 8001a2b0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800030b0:	1d478793          	addi	a5,a5,468 # 8001a280 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    800030c4:	1c070713          	addi	a4,a4,448 # 8001a280 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    800030f2:	19270713          	addi	a4,a4,402 # 8001a280 <log>
  ...
  release(&log.lock);
    ...
    80003104:	18050513          	addi	a0,a0,384 # 8001a280 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    8000322a:	1a250513          	addi	a0,a0,418 # 8001a3c8 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003248:	18450513          	addi	a0,a0,388 # 8001a3c8 <ftable>
    8000324c:	4d8020ef          	jal	80005724 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003250:	00017497          	auipc	s1,0x17
    80003254:	19048493          	addi	s1,s1,400 # 8001a3e0 <ftable+0x18>
    80003258:	00018717          	auipc	a4,0x18
    8000325c:	12870713          	addi	a4,a4,296 # 8001b380 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    80003270:	15c50513          	addi	a0,a0,348 # 8001a3c8 <ftable>
  ...
  return 0;
    ...
    80003284:	14850513          	addi	a0,a0,328 # 8001a3c8 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800032a8:	12450513          	addi	a0,a0,292 # 8001a3c8 <ftable>
  ...
  release(&ftable.lock);
    ...
    800032be:	10e50513          	addi	a0,a0,270 # 8001a3c8 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800032ee:	0de50513          	addi	a0,a0,222 # 8001a3c8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003328:	0a450513          	addi	a0,a0,164 # 8001a3c8 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003360:	06c50513          	addi	a0,a0,108 # 8001a3c8 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003486:	ea670713          	addi	a4,a4,-346 # 8001a328 <devsw>
    ...
    800034c0:	10078e63          	beqz	a5,800035dc <filewrite+0x120>
{
  ...
  if(f->type == FD_PIPE){
    ...
    8000352c:	e0070713          	addi	a4,a4,-512 # 8001a328 <devsw>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80003b60:	0127b023          	sd	s2,0(a5) # fffffffffffff000 <end+0xffffffff7ffdba40>
  for(argc = 0; argv[argc]; argc++) {
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80004794:	bf078793          	addi	a5,a5,-1040 # 8001b380 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    800047a8:	bdc78793          	addi	a5,a5,-1060 # 8001b380 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    800047d0:	bcc50513          	addi	a0,a0,-1076 # 8001b398 <disk+0x18>
...
00000000800047f8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80004810:	c9c50513          	addi	a0,a0,-868 # 8001b4a8 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80004874:	75f68693          	addi	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fdb19f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    800048be:	ac648493          	addi	s1,s1,-1338 # 8001b380 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    800048dc:	ab073703          	ld	a4,-1360(a4) # 8001b388 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    800048f0:	a9448493          	addi	s1,s1,-1388 # 8001b380 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800049ee:	abe50513          	addi	a0,a0,-1346 # 8001b4a8 <disk+0x128>
    800049f2:	533000ef          	jal	80005724 <acquire>
  for(int i = 0; i < NUM; i++){
    800049f6:	44a1                	li	s1,8
      disk.free[i] = 0;
    800049f8:	00017a97          	auipc	s5,0x17
    800049fc:	988a8a93          	addi	s5,s5,-1656 # 8001b380 <disk>
  for(int i = 0; i < 3; i++){
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80004a22:	96270713          	addi	a4,a4,-1694 # 8001b380 <disk>
  ...
  while(1){
    ...
    80004a58:	a5458593          	addi	a1,a1,-1452 # 8001b4a8 <disk+0x128>
    80004a5c:	00017517          	auipc	a0,0x17
    80004a60:	93c50513          	addi	a0,a0,-1732 # 8001b398 <disk+0x18>
  ...
  if(write)
    ...
    80004a7c:	90878793          	addi	a5,a5,-1784 # 8001b380 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80004b52:	95a90913          	addi	s2,s2,-1702 # 8001b4a8 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80004b7a:	80a78793          	addi	a5,a5,-2038 # 8001b380 <disk>
    80004b7e:	97ba                	add	a5,a5,a4
    80004b80:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80004b84:	00016997          	auipc	s3,0x16
    80004b88:	7fc98993          	addi	s3,s3,2044 # 8001b380 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80004bac:	90050513          	addi	a0,a0,-1792 # 8001b4a8 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80004bda:	7aa48493          	addi	s1,s1,1962 # 8001b380 <disk>
    80004bde:	00017517          	auipc	a0,0x17
    80004be2:	8ca50513          	addi	a0,a0,-1846 # 8001b4a8 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80004c56:	85650513          	addi	a0,a0,-1962 # 8001b4a8 <disk+0x128>
...
0000000080004cbc <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    80004cca:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdb23f>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80004dc2:	70250513          	addi	a0,a0,1794 # 800234c0 <cons>
  ...
  while(n > 0){
    ...
    80004dce:	6f648493          	addi	s1,s1,1782 # 800234c0 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    80004dd6:	78690913          	addi	s2,s2,1926 # 80023558 <cons+0x98>
  while(n > 0){
    ...
    80004e0e:	6b670713          	addi	a4,a4,1718 # 800234c0 <cons>
    ...
    80004e58:	66c50513          	addi	a0,a0,1644 # 800234c0 <cons>
  ...
  return target - n;
    ...
    80004e7e:	6cf72f23          	sw	a5,1758(a4) # 80023558 <cons+0x98>
  ...
  release(&cons.lock);
    ...
    80004e94:	63050513          	addi	a0,a0,1584 # 800234c0 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    80004ee8:	5dc50513          	addi	a0,a0,1500 # 800234c0 <cons>
  ...
  release(&cons.lock);
    ...
    80004f0e:	5b650513          	addi	a0,a0,1462 # 800234c0 <cons>
  ...
  switch(c){
    ...
    80004f2c:	59870713          	addi	a4,a4,1432 # 800234c0 <cons>
    ...
    80004f52:	57278793          	addi	a5,a5,1394 # 800234c0 <cons>
    ...
    80004f7e:	5de7a783          	lw	a5,1502(a5) # 80023558 <cons+0x98>
    ...
    80004ff0:	4d470713          	addi	a4,a4,1236 # 800234c0 <cons>
    ...
    80005006:	54f72f23          	sw	a5,1374(a4) # 80023560 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80005024:	4a078793          	addi	a5,a5,1184 # 800234c0 <cons>
    ...
    80005046:	50c7ad23          	sw	a2,1306(a5) # 8002355c <cons+0x9c>
        wakeup(&cons.r);
    8000504a:	0001e517          	auipc	a0,0x1e
    8000504e:	50e50513          	addi	a0,a0,1294 # 80023558 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    8000506c:	45850513          	addi	a0,a0,1112 # 800234c0 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    8000507c:	2b078793          	addi	a5,a5,688 # 8001a328 <devsw>
...
printf(char *fmt, ...)
{
  ...
  locking = pr.locking;
    ...
    80005148:	43c7a783          	lw	a5,1084(a5) # 80023580 <pr+0x18>
  ...
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    ...
    80005194:	3d850513          	addi	a0,a0,984 # 80023568 <pr>
  ...
  return 0;
    ...
    800053ec:	18050513          	addi	a0,a0,384 # 80023568 <pr>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    80005406:	1607af23          	sw	zero,382(a5) # 80023580 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    8000542a:	e4f72b23          	sw	a5,-426(a4) # 8000a27c <panicked>
  for(;;)
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    8000543e:	12e48493          	addi	s1,s1,302 # 80023568 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    800054a4:	0e850513          	addi	a0,a0,232 # 80023588 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    800054c8:	db87a783          	lw	a5,-584(a5) # 8000a27c <panicked>
...
uartstart()
{
  while(1){
    ...
    800054fe:	d867b783          	ld	a5,-634(a5) # 8000a280 <uart_tx_r>
    80005502:	00005717          	auipc	a4,0x5
    80005506:	d8673703          	ld	a4,-634(a4) # 8000a288 <uart_tx_w>
    8000550a:	08f70163          	beq	a4,a5,8000558c <uartstart+0x92>
{
    ...
    8000552c:	060a8a93          	addi	s5,s5,96 # 80023588 <uart_tx_lock>
    uart_tx_r += 1;
    80005530:	00005497          	auipc	s1,0x5
    80005534:	d5048493          	addi	s1,s1,-688 # 8000a280 <uart_tx_r>
    ...
    80005540:	d4c98993          	addi	s3,s3,-692 # 8000a288 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
0000000080005596 <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    800055ac:	fe050513          	addi	a0,a0,-32 # 80023588 <uart_tx_lock>
    800055b0:	174000ef          	jal	80005724 <acquire>
  if(panicked){
    800055b4:	00005797          	auipc	a5,0x5
    800055b8:	cc87a783          	lw	a5,-824(a5) # 8000a27c <panicked>
    800055bc:	efbd                	bnez	a5,8000563a <uartputc+0xa4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800055be:	00005717          	auipc	a4,0x5
    800055c2:	cca73703          	ld	a4,-822(a4) # 8000a288 <uart_tx_w>
    800055c6:	00005797          	auipc	a5,0x5
    800055ca:	cba7b783          	ld	a5,-838(a5) # 8000a280 <uart_tx_r>
    800055ce:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    800055d2:	0001e997          	auipc	s3,0x1e
    800055d6:	fb698993          	addi	s3,s3,-74 # 80023588 <uart_tx_lock>
    800055da:	00005497          	auipc	s1,0x5
    800055de:	ca648493          	addi	s1,s1,-858 # 8000a280 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800055e2:	00005917          	auipc	s2,0x5
    800055e6:	ca690913          	addi	s2,s2,-858 # 8000a288 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    80005608:	f8448493          	addi	s1,s1,-124 # 80023588 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    8000561c:	c6e7b823          	sd	a4,-912(a5) # 8000a288 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80005682:	f0a48493          	addi	s1,s1,-246 # 80023588 <uart_tx_lock>
