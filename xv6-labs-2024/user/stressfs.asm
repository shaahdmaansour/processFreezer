...
main(int argc, char *argv[])
{
  ...
  22:	98278793          	addi	a5,a5,-1662 # 9a0 <malloc+0x12c>
  26:	6398                	ld	a4,0(a5)
  ...
  38:	93c50513          	addi	a0,a0,-1732 # 970 <malloc+0xfc>
  3c:	780000ef          	jal	7bc <printf>
  ...
  68:	92450513          	addi	a0,a0,-1756 # 988 <malloc+0x114>
  6c:	750000ef          	jal	7bc <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 456:	892a                	mv	s2,a0
  ...
  neg = 0;
  if(sgn && xx < 0){
 458:	cac9                	beqz	a3,4ea <printint+0xa0>
 45a:	01f5d79b          	srliw	a5,a1,0x1f
 45e:	c7d1                	beqz	a5,4ea <printint+0xa0>
    neg = 1;
    x = -xx;
 ...
 472:	54a80813          	addi	a6,a6,1354 # 9b8 <digits>
 476:	88ba                	mv	a7,a4
 ...
 498:	fcc7ffe3          	bgeu	a5,a2,476 <printint+0x2c>
  if(neg)
 49c:	00030c63          	beqz	t1,4b4 <printint+0x6a>
    buf[i++] = '-';
 4a0:	fd050793          	addi	a5,a0,-48
 4a4:	00878533          	add	a0,a5,s0
 4a8:	02d00793          	li	a5,45
 4ac:	fef50823          	sb	a5,-16(a0)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fc:	20048963          	beqz	s1,70e <vprintf+0x220>
 ...
 540:	1c048063          	beqz	s1,700 <vprintf+0x212>
    c0 = fmt[i] & 0xff;
 ...
 558:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
 55c:	1a060e63          	beqz	a2,718 <vprintf+0x22a>
      if(c0 == 'd'){
 ...
 5ba:	16051963          	bnez	a0,72c <vprintf+0x23e>
 5be:	16070763          	beqz	a4,72c <vprintf+0x23e>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 6c4:	cc91                	beqz	s1,6e0 <vprintf+0x1f2>
        for(; *s; s++)
 6c6:	0004c583          	lbu	a1,0(s1)
 6ca:	c985                	beqz	a1,6fa <vprintf+0x20c>
          putc(fd, *s);
 6cc:	855a                	mv	a0,s6
 6ce:	d5fff0ef          	jal	42c <putc>
        for(; *s; s++)
 6d2:	0485                	addi	s1,s1,1
 6d4:	0004c583          	lbu	a1,0(s1)
 6d8:	f9f5                	bnez	a1,6cc <vprintf+0x1de>
        if((s = va_arg(ap, char*)) == 0)
 6da:	8bce                	mv	s7,s3
      state = 0;
 6dc:	4981                	li	s3,0
 6de:	bd91                	j	532 <vprintf+0x44>
          s = "(null)";
 6e0:	00000497          	auipc	s1,0x0
 6e4:	2d048493          	addi	s1,s1,720 # 9b0 <malloc+0x13c>
        for(; *s; s++)
 6e8:	02800593          	li	a1,40
 6ec:	b7c5                	j	6cc <vprintf+0x1de>
        putc(fd, '%');
 6ee:	85be                	mv	a1,a5
 6f0:	855a                	mv	a0,s6
 6f2:	d3bff0ef          	jal	42c <putc>
      state = 0;
 6f6:	4981                	li	s3,0
 6f8:	bd2d                	j	532 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
 6fa:	8bce                	mv	s7,s3
      state = 0;
 6fc:	4981                	li	s3,0
 6fe:	bd15                	j	532 <vprintf+0x44>
 ...
 716:	8082                	ret
      if(c0 == 'd'){
 718:	06400713          	li	a4,100
 71c:	e6e789e3          	beq	a5,a4,58e <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
 ...
 72c:	07500513          	li	a0,117
 730:	eaa786e3          	beq	a5,a0,5dc <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
 734:	f8b60513          	addi	a0,a2,-117
 738:	e119                	bnez	a0,73e <vprintf+0x250>
 73a:	ea069de3          	bnez	a3,5f4 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 73e:	f8b58513          	addi	a0,a1,-117
 742:	e119                	bnez	a0,748 <vprintf+0x25a>
 744:	ec0715e3          	bnez	a4,60e <vprintf+0x120>
      } else if(c0 == 'x'){
 748:	07800513          	li	a0,120
 74c:	eca78ee3          	beq	a5,a0,628 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
 750:	f8860613          	addi	a2,a2,-120
 754:	e219                	bnez	a2,75a <vprintf+0x26c>
 756:	ee0695e3          	bnez	a3,640 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 75a:	f8858593          	addi	a1,a1,-120
 75e:	e199                	bnez	a1,764 <vprintf+0x276>
 760:	ee071de3          	bnez	a4,65a <vprintf+0x16c>
      } else if(c0 == 'p'){
 764:	07000713          	li	a4,112
 768:	f0e786e3          	beq	a5,a4,674 <vprintf+0x186>
      } else if(c0 == 's'){
 76c:	07300713          	li	a4,115
 770:	f4e786e3          	beq	a5,a4,6bc <vprintf+0x1ce>
      } else if(c0 == '%'){
 774:	02500713          	li	a4,37
 778:	f6e78be3          	beq	a5,a4,6ee <vprintf+0x200>
        putc(fd, '%');
 77c:	02500593          	li	a1,37
 780:	855a                	mv	a0,s6
 782:	cabff0ef          	jal	42c <putc>
        putc(fd, c0);
 786:	85a6                	mv	a1,s1
 788:	855a                	mv	a0,s6
 78a:	ca3ff0ef          	jal	42c <putc>
      state = 0;
 78e:	4981                	li	s3,0
 790:	b34d                	j	532 <vprintf+0x44>
