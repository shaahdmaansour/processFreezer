...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	22e58593          	addi	a1,a1,558 # 1240 <malloc+0xf6>
      1a:	8532                	mv	a0,a2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	1fc58593          	addi	a1,a1,508 # 1250 <malloc+0x106>
      5c:	4509                	li	a0,2
      5e:	00a010ef          	jal	1068 <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	1d650513          	addi	a0,a0,470 # 1258 <malloc+0x10e>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	2ae70713          	addi	a4,a4,686 # 1358 <malloc+0x20e>
    ...
    panic("runcmd");
      ...
      c6:	19e50513          	addi	a0,a0,414 # 1260 <malloc+0x116>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	18c58593          	addi	a1,a1,396 # 1268 <malloc+0x11e>
      e4:	4509                	li	a0,2
      e6:	783000ef          	jal	1068 <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	16858593          	addi	a1,a1,360 # 1278 <malloc+0x12e>
     118:	4509                	li	a0,2
     11a:	74f000ef          	jal	1068 <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	11650513          	addi	a0,a0,278 # 1288 <malloc+0x13e>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	de4b0b13          	addi	s6,s6,-540 # 12b0 <malloc+0x166>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e6:	dae50513          	addi	a0,a0,-594 # 1290 <malloc+0x146>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     5a6:	d1660613          	addi	a2,a2,-746 # 12b8 <malloc+0x16e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5da:	d02b0b13          	addi	s6,s6,-766 # 12d8 <malloc+0x18e>
  ...
  return ret;
     ...
     60c:	cb850513          	addi	a0,a0,-840 # 12c0 <malloc+0x176>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     65a:	c7250513          	addi	a0,a0,-910 # 12c8 <malloc+0x17e>
...
0000000000000682 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     6a2:	c4260613          	addi	a2,a2,-958 # 12e0 <malloc+0x196>
     6a6:	85a6                	mv	a1,s1
     6a8:	854a                	mv	a0,s2
...
00000000000006e2 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     700:	beca0a13          	addi	s4,s4,-1044 # 12e8 <malloc+0x19e>
  ...
  if(peek(ps, es, ";")){
     ...
     72a:	bca60613          	addi	a2,a2,-1078 # 12f0 <malloc+0x1a6>
     72e:	85ce                	mv	a1,s3
     730:	854a                	mv	a0,s2
...
000000000000076a <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     780:	b3c60613          	addi	a2,a2,-1220 # 12b8 <malloc+0x16e>
  ...
  if(!peek(ps, es, ")"))
     ...
     7a4:	b6860613          	addi	a2,a2,-1176 # 1308 <malloc+0x1be>
     7a8:	85ca                	mv	a1,s2
     7aa:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7da:	b2250513          	addi	a0,a0,-1246 # 12f8 <malloc+0x1ae>
     7de:	86dff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7e2:	00001517          	auipc	a0,0x1
     7e6:	b2e50513          	addi	a0,a0,-1234 # 1310 <malloc+0x1c6>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     80e:	b6670713          	addi	a4,a4,-1178 # 1370 <malloc+0x226>
...
000000000000086e <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     89e:	9ae60613          	addi	a2,a2,-1618 # 1248 <malloc+0xfe>
     8a2:	85a6                	mv	a1,s1
     8a4:	854a                	mv	a0,s2
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8cc:	a6058593          	addi	a1,a1,-1440 # 1328 <malloc+0x1de>
     8d0:	4509                	li	a0,2
     8d2:	796000ef          	jal	1068 <fprintf>
    panic("syntax");
     8d6:	00001517          	auipc	a0,0x1
     8da:	9ea50513          	addi	a0,a0,-1558 # 12c0 <malloc+0x176>
...
00000000000008e2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8f8:	a4490913          	addi	s2,s2,-1468 # 1338 <malloc+0x1ee>
     8fc:	85a6                	mv	a1,s1
     8fe:	854a                	mv	a0,s2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     994:	9b058593          	addi	a1,a1,-1616 # 1340 <malloc+0x1f6>
     998:	4509                	li	a0,2
     99a:	6ce000ef          	jal	1068 <fprintf>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     d44:	00000817          	auipc	a6,0x0
     d48:	64480813          	addi	a6,a6,1604 # 1388 <digits>
     d4c:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f70:	41cb8b93          	addi	s7,s7,1052 # 1388 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     fba:	39a48493          	addi	s1,s1,922 # 1350 <malloc+0x206>
        for(; *s; s++)
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    11ac:	ee078793          	addi	a5,a5,-288 # 2088 <base>
