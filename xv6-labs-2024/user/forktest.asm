...
forktest(void)
{
  ...
  34:	3f050513          	addi	a0,a0,1008 # 420 <ptree+0x8>
  ...
  56:	41e50513          	addi	a0,a0,1054 # 470 <ptree+0x58>
  ...
  6c:	3c850513          	addi	a0,a0,968 # 430 <ptree+0x18>
  ...
  7e:	3ce50513          	addi	a0,a0,974 # 448 <ptree+0x30>
  ...
  ae:	3b650513          	addi	a0,a0,950 # 460 <ptree+0x48>
...
stat(const char *n, struct stat *st)
{
 ...
 23e:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 240:	85ca                	mv	a1,s2
 242:	14e000ef          	jal	390 <fstat>
 246:	892a                	mv	s2,a0
  close(fd);
 248:	8526                	mv	a0,s1
 24a:	1ae000ef          	jal	3f8 <close>
  return r;
 24e:	64a2                	ld	s1,8(sp)
}
 250:	854a                	mv	a0,s2
