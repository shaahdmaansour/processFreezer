...
forktest(void)
{
  ...
  34:	40050513          	addi	a0,a0,1024 # 430 <meminfo+0xe>
  ...
  56:	42e50513          	addi	a0,a0,1070 # 480 <meminfo+0x5e>
  ...
  6c:	3d850513          	addi	a0,a0,984 # 440 <meminfo+0x1e>
  ...
  7e:	3de50513          	addi	a0,a0,990 # 458 <meminfo+0x36>
  ...
  ae:	3c650513          	addi	a0,a0,966 # 470 <meminfo+0x4e>
...
stat(const char *n, struct stat *st)
{
 ...
 24e:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 250:	85ca                	mv	a1,s2
 252:	150000ef          	jal	3a2 <fstat>
 256:	892a                	mv	s2,a0
  close(fd);
 258:	8526                	mv	a0,s1
 25a:	1b0000ef          	jal	40a <close>
  return r;
 25e:	64a2                	ld	s1,8(sp)
}
 260:	854a                	mv	a0,s2
