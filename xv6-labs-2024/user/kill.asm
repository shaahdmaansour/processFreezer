...
main(int argc, char **argv)
{
  ...
  44:	8a058593          	addi	a1,a1,-1888 # 8e0 <malloc+0xf8>
  48:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e6:	51e80813          	addi	a6,a6,1310 # 900 <digits>
 3ea:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 60e:	2f6b8b93          	addi	s7,s7,758 # 900 <digits>
 ...
 658:	2a448493          	addi	s1,s1,676 # 8f8 <malloc+0x110>
        for(; *s; s++)
