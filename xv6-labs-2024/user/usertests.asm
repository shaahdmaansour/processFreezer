...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     18a:	3f9040ef          	jal	4d82 <unlink>
  close(fd1);
     18e:	8526                	mv	a0,s1
     190:	40b040ef          	jal	4d9a <close>
  close(fd2);
     194:	854a                	mv	a0,s2
     196:	405040ef          	jal	4d9a <close>
}
...
00000000000001be <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     1ee:	85ce                	mv	a1,s3
     1f0:	8552                	mv	a0,s4
     1f2:	379040ef          	jal	4d6a <open>
    close(fd);
     1f6:	3a5040ef          	jal	4d9a <close>
  for(i = 0; i < N; i++){
...
0000000000000240 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    if(fd < 0){
     ...
     2a2:	85d2                	mv	a1,s4
     2a4:	854a                	mv	a0,s2
     2a6:	2cd040ef          	jal	4d72 <write>
      if(cc != sz){
     2aa:	04951363          	bne	a0,s1,2f0 <bigwrite+0xb0>
    close(fd);
     2ae:	854a                	mv	a0,s2
     2b0:	2eb040ef          	jal	4d9a <close>
    unlink("bigwrite");
     2b4:	8556                	mv	a0,s5
     2b6:	2cd040ef          	jal	4d82 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
...
badwrite(char *s)
{
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     34e:	865a                	mv	a2,s6
     350:	85d2                	mv	a1,s4
     352:	221040ef          	jal	4d72 <write>
    close(fd);
     356:	8526                	mv	a0,s1
     358:	243040ef          	jal	4d9a <close>
    unlink("junk");
     35c:	854e                	mv	a0,s3
     35e:	225040ef          	jal	4d82 <unlink>
  for(int i = 0; i < assumed_free; i++){
...
outofinodes(char *s)
{
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
     434:	854a                	mv	a0,s2
     436:	14d040ef          	jal	4d82 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
     43a:	85d2                	mv	a1,s4
     43c:	854a                	mv	a0,s2
     43e:	12d040ef          	jal	4d6a <open>
    if(fd < 0){
...
00000000000004ac <copyin>:
{
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int n = write(fd, (void*)addr, 8192);
     51a:	8652                	mv	a2,s4
     51c:	85ce                	mv	a1,s3
     51e:	055040ef          	jal	4d72 <write>
    if(n >= 0){
     522:	06055d63          	bgez	a0,59c <copyin+0xf0>
    close(fd);
     526:	8526                	mv	a0,s1
     528:	073040ef          	jal	4d9a <close>
    unlink("copyin1");
     52c:	8556                	mv	a0,s5
     52e:	055040ef          	jal	4d82 <unlink>
    n = write(1, (char*)addr, 8192);
     532:	8652                	mv	a2,s4
     534:	85ce                	mv	a1,s3
     536:	8562                	mv	a0,s8
     538:	03b040ef          	jal	4d72 <write>
    if(n > 0){
...
00000000000005f0 <copyout>:
{
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    close(fds[0]);
     ...
     6a8:	6f2040ef          	jal	4d9a <close>
    close(fds[1]);
     6ac:	f6c42503          	lw	a0,-148(s0)
     6b0:	6ea040ef          	jal	4d9a <close>
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
...
0000000000000736 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     822:	560040ef          	jal	4d82 <unlink>
  close(fd1);
     826:	854e                	mv	a0,s3
     828:	572040ef          	jal	4d9a <close>
  close(fd2);
     82c:	8526                	mv	a0,s1
     82e:	56c040ef          	jal	4d9a <close>
  close(fd3);
     832:	854a                	mv	a0,s2
     834:	566040ef          	jal	4d9a <close>
}
...
00000000000008d4 <writetest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     91c:	85d2                	mv	a1,s4
     91e:	854e                	mv	a0,s3
     920:	452040ef          	jal	4d72 <write>
     924:	08951563          	bne	a0,s1,9ae <writetest+0xda>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     928:	8626                	mv	a2,s1
     92a:	85da                	mv	a1,s6
     92c:	854e                	mv	a0,s3
     92e:	444040ef          	jal	4d72 <write>
...
0000000000000b76 <unlinkread>:
{
  ...
  write(fd, "hello", SZ);
     ...
     ba6:	1cc040ef          	jal	4d72 <write>
  close(fd);
     baa:	8526                	mv	a0,s1
     bac:	1ee040ef          	jal	4d9a <close>
  fd = open("unlinkread", O_RDWR);
     bb0:	4589                	li	a1,2
     bb2:	00005517          	auipc	a0,0x5
     bb6:	c4e50513          	addi	a0,a0,-946 # 5800 <malloc+0x62c>
     bba:	1b0040ef          	jal	4d6a <open>
     bbe:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bde:	18c040ef          	jal	4d6a <open>
     be2:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     be4:	460d                	li	a2,3
     be6:	00005597          	auipc	a1,0x5
     bea:	c9258593          	addi	a1,a1,-878 # 5878 <malloc+0x6a4>
     bee:	184040ef          	jal	4d72 <write>
  close(fd1);
     bf2:	854a                	mv	a0,s2
     bf4:	1a6040ef          	jal	4d9a <close>
...
0000000000000ccc <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d12:	060040ef          	jal	4d72 <write>
     d16:	4795                	li	a5,5
     d18:	0cf51e63          	bne	a0,a5,df4 <linktest+0x128>
  close(fd);
     d1c:	8526                	mv	a0,s1
     d1e:	07c040ef          	jal	4d9a <close>
  if(link("lf1", "lf2") < 0){
...
0000000000001240 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1258:	313030ef          	jal	4d6a <open>
    125c:	33f030ef          	jal	4d9a <close>
  pid = fork();
  ...
  if(pid == 0){
    ...
    12a8:	8652                	mv	a2,s4
    12aa:	85de                	mv	a1,s7
    12ac:	2c7030ef          	jal	4d72 <write>
      if(n != 10){
    12b0:	07451363          	bne	a0,s4,1316 <truncate3+0xd6>
      close(fd);
    12b4:	8526                	mv	a0,s1
    12b6:	2e5030ef          	jal	4d9a <close>
      fd = open("truncfile", O_RDONLY);
    12ba:	4581                	li	a1,0
    12bc:	854e                	mv	a0,s3
    12be:	2ad030ef          	jal	4d6a <open>
    12c2:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    12c4:	8662                	mv	a2,s8
    12c6:	85e6                	mv	a1,s9
    ...
    1360:	864e                	mv	a2,s3
    1362:	85de                	mv	a1,s7
    1364:	20f030ef          	jal	4d72 <write>
    if(n != 3){
    1368:	05351463          	bne	a0,s3,13b0 <truncate3+0x170>
    close(fd);
    136c:	8526                	mv	a0,s1
    136e:	22d030ef          	jal	4d9a <close>
  for(int i = 0; i < 150; i++){
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1990:	85ce                	mv	a1,s3
    1992:	854a                	mv	a0,s2
    1994:	3d6030ef          	jal	4d6a <open>
        if(fd < 0){
    1998:	fa054fe3          	bltz	a0,1956 <createdelete+0x90>
        close(fd);
    199c:	3fe030ef          	jal	4d9a <close>
        if(i > 0 && (i % 2 ) == 0){
...
0000000000001aa4 <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2c:	85e2                	mv	a1,s8
    1b2e:	855a                	mv	a0,s6
    1b30:	23a030ef          	jal	4d6a <open>
    1b34:	266030ef          	jal	4d9a <close>
    1b38:	a021                	j	1b40 <linkunlink+0x9c>
      unlink("x");
    1b3a:	855a                	mv	a0,s6
    1b3c:	246030ef          	jal	4d82 <unlink>
  for(i = 0; i < 100; i++){
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1da4:	0007c603          	lbu	a2,0(a5) # ffffffffffffe000 <base+0xfffffffffffee388>
    1da8:	85a6                	mv	a1,s1
...
0000000000001fb2 <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    1fbe:	595020ef          	jal	4d52 <sbrk>
  uint64 top = (uint64) sbrk(0);
    1fc2:	4501                	li	a0,0
    1fc4:	58f020ef          	jal	4d52 <sbrk>
  if((top % PGSIZE) != 0){
    1fc8:	03451793          	slli	a5,a0,0x34
    1fcc:	e7bd                	bnez	a5,203a <copyinstr3+0x88>
  top = (uint64) sbrk(0);
    1fce:	4501                	li	a0,0
    1fd0:	583020ef          	jal	4d52 <sbrk>
  if(top % PGSIZE){
...
00000000000021be <sbrkbasic>:
{
  ...
  c = sbrk(1);
    229c:	4505                	li	a0,1
    229e:	2b5020ef          	jal	4d52 <sbrk>
  c = sbrk(1);
    22a2:	4505                	li	a0,1
    22a4:	2af020ef          	jal	4d52 <sbrk>
  if(c != a + 1){
...
000000000000230a <sbrkmuch>:
{
  ...
  oldbrk = sbrk(0);
    231c:	4501                	li	a0,0
    231e:	235020ef          	jal	4d52 <sbrk>
    2322:	892a                	mv	s2,a0
  a = sbrk(0);
    2324:	4501                	li	a0,0
    2326:	22d020ef          	jal	4d52 <sbrk>
    232a:	84aa                	mv	s1,a0
  p = sbrk(amt);
    232c:	06400537          	lui	a0,0x6400
    2330:	9d05                	subw	a0,a0,s1
    2332:	221020ef          	jal	4d52 <sbrk>
  if (p != a) {
    2336:	0aa49463          	bne	s1,a0,23de <sbrkmuch+0xd4>
  char *eee = sbrk(0);
    233a:	4501                	li	a0,0
    233c:	217020ef          	jal	4d52 <sbrk>
    2340:	87aa                	mv	a5,a0
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2360:	4501                	li	a0,0
    2362:	1f1020ef          	jal	4d52 <sbrk>
    2366:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2368:	757d                	lui	a0,0xfffff
    236a:	1e9020ef          	jal	4d52 <sbrk>
  if(c == (char*)0xffffffffffffffffL){
    236e:	57fd                	li	a5,-1
    2370:	08f50163          	beq	a0,a5,23f2 <sbrkmuch+0xe8>
  c = sbrk(0);
    2374:	4501                	li	a0,0
    2376:	1dd020ef          	jal	4d52 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    2382:	4501                	li	a0,0
    2384:	1cf020ef          	jal	4d52 <sbrk>
    2388:	84aa                	mv	s1,a0
  c = sbrk(PGSIZE);
    238a:	6505                	lui	a0,0x1
    238c:	1c7020ef          	jal	4d52 <sbrk>
    2390:	8a2a                	mv	s4,a0
  if(c != a || sbrk(0) != a + PGSIZE){
    2392:	08a49663          	bne	s1,a0,241e <sbrkmuch+0x114>
    2396:	4501                	li	a0,0
    2398:	1bb020ef          	jal	4d52 <sbrk>
  ...
  a = sbrk(0);
    23b4:	4501                	li	a0,0
    23b6:	19d020ef          	jal	4d52 <sbrk>
    23ba:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    23bc:	4501                	li	a0,0
    23be:	195020ef          	jal	4d52 <sbrk>
    23c2:	40a9053b          	subw	a0,s2,a0
    23c6:	18d020ef          	jal	4d52 <sbrk>
  if(c != a){
...
0000000000002462 <sbrkarg>:
{
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    249e:	85ca                	mv	a1,s2
    24a0:	8526                	mv	a0,s1
    24a2:	0d1020ef          	jal	4d72 <write>
    24a6:	02054c63          	bltz	a0,24de <sbrkarg+0x7c>
  close(fd);
    24aa:	8526                	mv	a0,s1
    24ac:	0ef020ef          	jal	4d9a <close>
  a = sbrk(PGSIZE);
    24b0:	6505                	lui	a0,0x1
    24b2:	0a1020ef          	jal	4d52 <sbrk>
  if(pipe((int *) a) != 0){
...
0000000000002506 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    251e:	04d020ef          	jal	4d6a <open>
  if (fd < 0) {
    2522:	02054563          	bltz	a0,254c <argptest+0x46>
    2526:	84aa                	mv	s1,a0
  read(fd, sbrk(0) - 1, -1);
    2528:	4501                	li	a0,0
    252a:	029020ef          	jal	4d52 <sbrk>
    252e:	567d                	li	a2,-1
...
0000000000002560 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2572:	7e0020ef          	jal	4d52 <sbrk>
    sbrk(-sz);
    2576:	40a0053b          	negw	a0,a0
    257a:	7d8020ef          	jal	4d52 <sbrk>
    exit(0);
    257e:	4501                	li	a0,0
...
000000000000261c <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    262c:	4501                	li	a0,0
    262e:	724020ef          	jal	4d52 <sbrk>
  if((top % 4096) != 0)
    2632:	03451793          	slli	a5,a0,0x34
    2636:	ebad                	bnez	a5,26a8 <sbrklast+0x8c>
  sbrk(4096);
    2638:	6505                	lui	a0,0x1
    263a:	718020ef          	jal	4d52 <sbrk>
  sbrk(10);
    263e:	4529                	li	a0,10
    2640:	712020ef          	jal	4d52 <sbrk>
  sbrk(-20);
    2644:	5531                	li	a0,-20
    2646:	70c020ef          	jal	4d52 <sbrk>
  top = (uint64) sbrk(0);
    264a:	4501                	li	a0,0
    264c:	706020ef          	jal	4d52 <sbrk>
    2650:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2666:	854a                	mv	a0,s2
    2668:	702020ef          	jal	4d6a <open>
    266c:	89aa                	mv	s3,a0
  write(fd, p, 1);
    266e:	4605                	li	a2,1
    2670:	85ca                	mv	a1,s2
    2672:	700020ef          	jal	4d72 <write>
  close(fd);
    2676:	854e                	mv	a0,s3
    2678:	722020ef          	jal	4d9a <close>
  fd = open(p, O_RDWR);
    267c:	4589                	li	a1,2
    267e:	854a                	mv	a0,s2
    2680:	6ea020ef          	jal	4d6a <open>
  p[0] = '\0';
...
00000000000026c0 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    26ce:	684020ef          	jal	4d52 <sbrk>
  volatile char *top = sbrk(0);
    26d2:	4501                	li	a0,0
    26d4:	67e020ef          	jal	4d52 <sbrk>
  *(top-1) = *(top-1) + 1;
...
00000000000028d2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    2954:	a039                	j	2962 <diskfull+0x90>
        close(fd);
    2956:	854e                	mv	a0,s3
    2958:	442020ef          	jal	4d9a <close>
    close(fd);
    295c:	854e                	mv	a0,s3
    295e:	43c020ef          	jal	4d9a <close>
  for(int i = 0; i < nzz; i++){
    2962:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
    29a4:	854a                	mv	a0,s2
    29a6:	3dc020ef          	jal	4d82 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    29aa:	85d2                	mv	a1,s4
    29ac:	854a                	mv	a0,s2
    29ae:	3bc020ef          	jal	4d6a <open>
    if(fd < 0)
    29b2:	00054763          	bltz	a0,29c0 <diskfull+0xee>
    close(fd);
    29b6:	3e4020ef          	jal	4d9a <close>
  for(int i = 0; i < nzz; i++){
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    unlink(name);
    2ac4:	855a                	mv	a0,s6
    2ac6:	2bc020ef          	jal	4d82 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    2aca:	85de                	mv	a1,s7
    2acc:	855a                	mv	a0,s6
    2ace:	29c020ef          	jal	4d6a <open>
    2ad2:	89aa                	mv	s3,a0
    if(fd < 0){
...
0000000000002cfc <subdir>:
{
  ...
  write(fd, "FF", 2);
    ...
    2d90:	7e3010ef          	jal	4d72 <write>
  close(fd);
    2d94:	8526                	mv	a0,s1
    2d96:	004020ef          	jal	4d9a <close>
  fd = open("dd/dd/../ff", 0);
    2d9a:	4581                	li	a1,0
    2d9c:	00004517          	auipc	a0,0x4
    2da0:	88450513          	addi	a0,a0,-1916 # 6620 <malloc+0x144c>
    2da4:	7c7010ef          	jal	4d6a <open>
    2da8:	84aa                	mv	s1,a0
  if(fd < 0){
...
00000000000035c0 <iref>:
{
    ...
    3626:	6dc010ef          	jal	4d02 <exit>
      close(fd);
    362a:	770010ef          	jal	4d9a <close>
    362e:	a825                	j	3666 <iref+0xa6>
    unlink("xx");
    3630:	854e                	mv	a0,s3
    3632:	750010ef          	jal	4d82 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    3636:	397d                	addiw	s2,s2,-1
    3638:	04090063          	beqz	s2,3678 <iref+0xb8>
    if(mkdir("irefd") != 0){
    363c:	8556                	mv	a0,s5
    363e:	754010ef          	jal	4d92 <mkdir>
    3642:	f161                	bnez	a0,3602 <iref+0x42>
    if(chdir("irefd") != 0){
    3644:	8556                	mv	a0,s5
    3646:	6f4010ef          	jal	4d3a <chdir>
    364a:	f571                	bnez	a0,3616 <iref+0x56>
    mkdir("");
    364c:	8526                	mv	a0,s1
    364e:	744010ef          	jal	4d92 <mkdir>
    link("README", "");
    3652:	85a6                	mv	a1,s1
    3654:	855a                	mv	a0,s6
    3656:	734010ef          	jal	4d8a <link>
    fd = open("", O_CREATE);
    365a:	85d2                	mv	a1,s4
    365c:	8526                	mv	a0,s1
    365e:	70c010ef          	jal	4d6a <open>
    if(fd >= 0)
    3662:	fc0554e3          	bgez	a0,362a <iref+0x6a>
    fd = open("xx", O_CREATE);
    3666:	85d2                	mv	a1,s4
    3668:	854e                	mv	a0,s3
    366a:	700010ef          	jal	4d6a <open>
    if(fd >= 0)
    366e:	fc0541e3          	bltz	a0,3630 <iref+0x70>
      close(fd);
    3672:	728010ef          	jal	4d9a <close>
    ...
    chdir("..");
    368c:	854e                	mv	a0,s3
    368e:	6ac010ef          	jal	4d3a <chdir>
    unlink("irefd");
    3692:	854a                	mv	a0,s2
    3694:	6ee010ef          	jal	4d82 <unlink>
  for(i = 0; i < NINODE + 1; i++){
...
0000000000003770 <forkforkfork>:
{
  ...
  sleep(10); // one second
    ...
    37fe:	56c010ef          	jal	4d6a <open>
    3802:	598010ef          	jal	4d9a <close>
...
000000000000380e <killstatus>:
{
    ...
    sleep(1);
    383c:	8556                	mv	a0,s5
    383e:	51c010ef          	jal	4d5a <sleep>
    kill(pid1);
    3842:	8526                	mv	a0,s1
    3844:	4de010ef          	jal	4d22 <kill>
    wait(&xst);
    3848:	8552                	mv	a0,s4
...
0000000000003890 <preempt>:
{
  ...
  kill(pid1);
    399a:	8526                	mv	a0,s1
    399c:	386010ef          	jal	4d22 <kill>
  kill(pid2);
    39a0:	854e                	mv	a0,s3
    39a2:	380010ef          	jal	4d22 <kill>
  kill(pid3);
    39a6:	8552                	mv	a0,s4
    39a8:	37a010ef          	jal	4d22 <kill>
  printf("wait... ");
...
0000000000003a4c <sbrkfail>:
{
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    a = sbrk(0);
    3b72:	4501                	li	a0,0
    3b74:	1de010ef          	jal	4d52 <sbrk>
    3b78:	892a                	mv	s2,a0
    sbrk(10*BIG);
    3b7a:	3e800537          	lui	a0,0x3e800
    3b7e:	1d4010ef          	jal	4d52 <sbrk>
...
0000000000003dbc <fourfiles>:
{
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    close(fd);
    3f04:	854e                	mv	a0,s3
    3f06:	695000ef          	jal	4d9a <close>
    if(total != N*SZ){
    3f0a:	05a91863          	bne	s2,s10,3f5a <fourfiles+0x19e>
    unlink(fname);
    3f0e:	8562                	mv	a0,s8
    3f10:	673000ef          	jal	4d82 <unlink>
  for(i = 0; i < NCHILD; i++){
...
0000000000003f8c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    413c:	4581                	li	a1,0
    413e:	854e                	mv	a0,s3
    4140:	42b000ef          	jal	4d6a <open>
    4144:	457000ef          	jal	4d9a <close>
      close(open(file, 0));
    4148:	4581                	li	a1,0
    414a:	854e                	mv	a0,s3
    414c:	41f000ef          	jal	4d6a <open>
    4150:	44b000ef          	jal	4d9a <close>
      close(open(file, 0));
    4154:	4581                	li	a1,0
    4156:	854e                	mv	a0,s3
    4158:	413000ef          	jal	4d6a <open>
    415c:	43f000ef          	jal	4d9a <close>
      close(open(file, 0));
    4160:	4581                	li	a1,0
    4162:	854e                	mv	a0,s3
    4164:	407000ef          	jal	4d6a <open>
    4168:	433000ef          	jal	4d9a <close>
      close(open(file, 0));
    416c:	4581                	li	a1,0
    416e:	854e                	mv	a0,s3
    4170:	3fb000ef          	jal	4d6a <open>
    4174:	427000ef          	jal	4d9a <close>
      close(open(file, 0));
    4178:	4581                	li	a1,0
    417a:	854e                	mv	a0,s3
    417c:	3ef000ef          	jal	4d6a <open>
    4180:	41b000ef          	jal	4d9a <close>
    if(pid == 0)
  ...
  for(i = 0; i < N; i++){
    ...
    41c8:	f935                	bnez	a0,413c <concreate+0x1b0>
      unlink(file);
    41ca:	854e                	mv	a0,s3
    41cc:	3b7000ef          	jal	4d82 <unlink>
      unlink(file);
    41d0:	854e                	mv	a0,s3
    41d2:	3b1000ef          	jal	4d82 <unlink>
      unlink(file);
    41d6:	854e                	mv	a0,s3
    41d8:	3ab000ef          	jal	4d82 <unlink>
      unlink(file);
    41dc:	854e                	mv	a0,s3
    41de:	3a5000ef          	jal	4d82 <unlink>
      unlink(file);
    41e2:	854e                	mv	a0,s3
    41e4:	39f000ef          	jal	4d82 <unlink>
      unlink(file);
    41e8:	854e                	mv	a0,s3
    41ea:	399000ef          	jal	4d82 <unlink>
    41ee:	bf59                	j	4184 <concreate+0x1f8>
      exit(0);
    41f0:	4501                	li	a0,0
    41f2:	311000ef          	jal	4d02 <exit>
      close(fd);
    41f6:	3a5000ef          	jal	4d9a <close>
    if(pid == 0) {
    41fa:	b599                	j	4040 <concreate+0xb4>
      close(fd);
    41fc:	39f000ef          	jal	4d9a <close>
      wait(&xstatus);
    4200:	8556                	mv	a0,s5
...
00000000000043f0 <bigargtest>:
{
  ...
  fd = open("bigarg-ok", 0);
    ...
    442a:	141000ef          	jal	4d6a <open>
  if(fd < 0){
    442e:	08054663          	bltz	a0,44ba <bigargtest+0xca>
  close(fd);
    4432:	169000ef          	jal	4d9a <close>
}
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
    4be0:	85ca                	mv	a1,s2
    4be2:	150000ef          	jal	4d32 <fstat>
    4be6:	892a                	mv	s2,a0
  close(fd);
    4be8:	8526                	mv	a0,s1
    4bea:	1b0000ef          	jal	4d9a <close>
  return r;
